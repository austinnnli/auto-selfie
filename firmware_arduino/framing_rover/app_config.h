...
#define ROVER_PIN_ASSERT(cond, msg) static_assert(cond, msg)
#else
#define ROVER_PIN_ASSERT(cond, msg) _Static_assert(cond, msg)
#endif

#define ROVER_CHECK_PIN(p) \
    ROVER_PIN_ASSERT(ROVER_PIN_OK(p), #p " is a reserved GPIO on the ESP32-S3 - see H-1 in app_config.h")
